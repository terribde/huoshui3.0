-- Generated by node scripts/build-schema.mjs. Edit supabase/*.sql sources.
BEGIN;

-- Source: supabase/migration-guard.sql
...
-- Source: supabase/production-compat.sql
